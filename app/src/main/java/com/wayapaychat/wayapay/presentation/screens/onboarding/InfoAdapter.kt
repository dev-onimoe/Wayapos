...
class InfoAdapter() : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    var infoData = ArrayList<InfoData>()
        set(value) {
            field = value
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as PromotionViewHolder).bind(infoData[position])
    }

    class PromotionViewHolder(private val binding: View) :
     ...
     */
    override fun getItemCount() = infoData.size
}
