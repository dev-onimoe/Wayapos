...
class Phone_transfer_fragment2(map: HashMap<String, String>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_phone_transfer_fragment2, container, false)
    ...
    private fun initializeViews(view : View) {
        ...
        val amount = view.findViewById<TextView>(R.id.tf_phone_amount)
        val description = view.findViewById<TextView>(R.id.tf_phone_note)
        val proceed_btn = view.findViewById<Button>(R.id.phone_tf_proceed2_btn)
        val error_text = view.findViewById<TextView>(R.id.phone_tf_error_text2)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String, map : HashMap<String, String>) =
            Phone_transfer_fragment2(map).apply {
