...
class Phone_transfer_fragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_phone_transfer_fragment1, container, false)
    ...
    private fun initializeViews(view : View) {
        ...
        val spinner = view.findViewById<Spinner>(R.id.tf_phone_recipient_type_spinner)
        val phone = view.findViewById<EditText>(R.id.tf_phone_phone)
        val fullName = view.findViewById<EditText>(R.id.tf_phone_fullname)
        val proceed_btn = view.findViewById<Button>(R.id.phone_tf_proceed1_btn)
        val error_text = view.findViewById<TextView>(R.id.phone_tf_error_text1)
        ...
        proceed_btn.setOnClickListener {
            if (recipient_type.text.toString().equals("Select recipient type", true)) {
                ...
                listener.switchFragments(
                    Phone_transfer_fragment2(ownMap),
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            Phone_transfer_fragment1().apply {
